...
const wchar_t* const keyword[] = {  // 关键字
    L"ret",      L"var",      L"con",        L"fun",      L"cls",     L"if",   L"lib",
    L"原生库", L"定义变量",   L"定义常量",   L"函数",  L"定义类",
    ...
    L"else",     L"否则",     L"遍历",       L"中间变量",
    L"整型", L"浮点型", L"精确浮点型", L"字符型", L"字符串型",
    L"int", L"float", L"double", L"char", L"str", NULL
};
